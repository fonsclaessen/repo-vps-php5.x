...
//    var setTooltipsOnColumnHeader = function (grid, iColumn, text) {
  //      var thd = $("thead:first", grid[0].grid.hDiv)[0];
    ...
    $("#jqGrid").jqGrid({
        ...
        headertitles: true,
        hiddengrid: true,
        colNames: ['P', 'PeriodeZZ', 'Opdrachtgever', 'Uren', 'Factuur', '', 'Datum', 'Vervalt', 'Betaald', 'Factuur', 'Voorschot', 'Co&ouml;peratie', 'Dienstverlening', '', 'Resteert', 'Btw', 'Factuur ADZ', '', 'C'],
...
//            { label: 'Btw', name: 'Btw', align: 'right', width: 45 },
            ...
            },
            {
                ...
                formatter: function (cellvalue, options, rowObject) {
					...
					//alert( rowObjecti[19] );
					//alert( rowObject.FactuurID);	
					//alert( options.rowData.FactuurID);	
					//alert(options);	

					
					//factuurid = (factuurid == undefined ? rowObject.id : factuurid);
                    //var factuurnummer1 = rowObject.Factuurnr;
                    //var factuurnummer2 = cellvalue;
                    var icoon_tonen = '';
                    ...
                    return '<a class="popup_factuur_opmerkingen fancybox.iframe ZZZa_pdfpopup" href="/index.php/pdf/pdfpopupfactuuropmerkingen/' + factuurid + '/' + contactmoment_id + '">' + icoon_tonen + '</a>';
                }
            }
        ],
        //

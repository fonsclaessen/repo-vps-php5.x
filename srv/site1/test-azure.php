//  /srv/zzp/site1/test-azure.php << 'EOF'
<?php
...
<head>
    <meta charset="UTF-8">
    <title>Azure SQL Test - PHP 5.6 + Alpine</title>
    <style>
...
<body>
    ...
    try {
        ...
        $stmt = $pdo->query("SELECT TOP 5 * FROM INFORMATION_SCHEMA.TABLES");
        echo "<table border='1' cellpadding='5'>";
        echo "<tr><th>Catalog</th><th>Schema</th><th>Table Name</th><th>Type</th></tr>";
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo "<tr>";
            echo "<td>" . htmlspecialchars($row['TABLE_CATALOG']) . "</td>";

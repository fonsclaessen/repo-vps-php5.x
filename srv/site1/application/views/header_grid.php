...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <link rel="stylesheet" href="/css/screen.css?12" type="text/css" media="screen" title="default" />
...
<!-- -->
      ...
      <script type="text/javascript">
         $(document).ready(function () {
            ...
            $(".popup_week").fancybox({
			 ...
			 $(".popup_factuur_opmerkingen").fancybox({
               maxWidth: 900,
               maxHeight: 600,
               fitToView: false,
               		//width		: '70%',
	...
	<script type="text/ecmascript" src="/jqueryui/jquery-ui.min.js"></script>
